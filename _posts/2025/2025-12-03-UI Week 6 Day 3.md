...
published: true
image: /assets/img/posts/2025/2025-12-03/title.gif
...
It starts with a missing mesh because I pasted the latest version, and didn't check what was in it before committing and saving 😂 Luckily git history is there and I fixed it pretty quick. 
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-12-03/badbot01.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-12-03/badbot02.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-12-03/splash01.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-12-03/badbot03.png){: w="400" }

 I got this:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-12-03/badbot04.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-12-03/goodbot01.png){: w="400" }
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-12-03/goodbot02.png){: w="400" }

I also had to feed it the context once more since this is a new chat. Adding more context uses up usage limits too though, so this honestly feels like a bit of a scam 😂
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-12-03/badbot05.png){: w="400" }

And when I go to test it it wasn't even working 😂 The limits are a bother. It is starting to feel like it's only worth using the free ones to make a roadmap and then find yourself your answers online.
...
#### Step 1: Basic Spring Physics System ⭐ START HERE
...
{% include embed/video.html src='/assets/img/posts/2025/2025-12-03/splash02.mp4' autoplay=true loop=true muted=true %}
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-12-03/cleanup01.png){: w="400" }
...
{% include embed/video.html src='/assets/img/posts/2025/2025-12-03/splash03.mp4' autoplay=true loop=true muted=true %}
...
{% include embed/video.html src='/assets/img/posts/2025/2025-12-03/splash04.mp4' autoplay=true loop=true muted=true %}
...
{% include embed/video.html src='/assets/img/posts/2025/2025-12-03/splash05.mp4' autoplay=true loop=true muted=true %}
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-12-03/displace01.png){: w="400" }

And one to calculate how far submerged something is:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-12-03/displace02.png){: w="400" }

And that gives us this:

{% include embed/video.html src='/assets/img/posts/2025/2025-12-03/displace03.mp4' autoplay=true loop=true muted=true %}
...
{% include embed/video.html src='/assets/img/posts/2025/2025-12-03/container01.mp4' autoplay=true loop=true muted=true %}

{% include embed/video.html src='/assets/img/posts/2025/2025-12-03/container02.mp4' autoplay=true loop=true muted=true %}
