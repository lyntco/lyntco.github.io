...
published: true
image: /assets/img/posts/2025/2025-10-26/title.png
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-10-26/engine01.png){: .right w="350" h="200" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-10-26/code01.png){: w="350" h="200" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-10-26/code02.png){: w="350" h="800" } 

And here is a video of the numbers doing something:

{% include embed/video.html src='/assets/img/posts/2025/2025-10-26/engine02.mp4' %}
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-10-26/engine03.png){: w="350" h="200" }

And now I can hook up the UI buttons to a new script with `Debug.Log`s for now:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-10-26/code03.png){: w="350" h="200" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-10-26/engine04.png){: w="350" h="200" }

So now I need the real functions to run. But I haven't written those yet, so I'll write it back in the `GameManager.cs`:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-10-26/code04.png){: w="350" h="200" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-10-26/code05.png){: w="350" h="200" }

That lets me place the reset functions into the `Interface.cs` like so:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-10-26/code06.png){: w="350" h="200" }

And when I test it, the right buttons reset the right values:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-10-26/engine05.gif){: w="350" }
