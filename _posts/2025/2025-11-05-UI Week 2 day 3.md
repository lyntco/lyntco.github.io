...
published: true
image: /assets/img/posts/2025/2025-11-04/boba-menu.png
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-constrain01.gif){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-constrain02.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-constrain03.png){: w="400" }
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-constrain04.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-constrain05.png){: w="400" }

...Except it's not that simple! The Y value is off - the `Debug.Log` I have here is the bottom left corner of the element:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-constrain06.png){: w="400" }

So it's pushing the mouse in an offset bound:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-constrain07.png){: w="400" }

A bit of research tells me that the Mouse position and the worldbound on an element are calculated differently.

![Dark mode only]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-constrain08.png){: .dark w="400" }
![Light mode only]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-constrain08-light.png){: .light w="400" }
_Thanks Gemini_

Now that I know there is a difference I can work towards making it line up. As a diagram this is what I understand:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-constrain09.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-constrain10.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-constrain11.png){: w="400" }
_The calculation only needs to invert the y coord_

Since Copilot gave me the code I put it in and tested it:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-constrain12.png){: w="400" }
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-constrain13.gif){: w="400" }
_Good bot_
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-constrain14.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-constrain15.png){: w="400" }
_Am I a vibe coder yet_

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-constrain16.gif){: w="600" }
_The test_
...
So my takeaway is that the value is the important thing here, not how it looks. You use the visuals to display the real values. So always start with the values and `Debug.Log` them 😄 Seems obvious now but not to a newbie like back then!
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-slidervalue01.png){: w="400" }
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-slidervalue02.png){: w="400" }
_No idea if this will work_

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-slidervalue03.gif){: w="400" }
...
It took me a bit of messing around with numbers but I finally got it lined up with a bit of math help from Mike 😅 I also needed to use the local position of the mouse instead of the Mouse position from the input - this way I can just use the height and make the number a percent of 1000 so the height can be anything.

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-slidervalue04.png){: w="400" }
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-slidervalue05.png){: w="400" }
_Mathematical!_

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-slidervalue06.gif){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-dragger01.png){: w="400" }
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-dragger02.png){: w="400" }
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-dragger03.png){: w="400" }
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-dragger04.png){: w="400" }

 The bottom property just needs to change, since I manually change it if I do I in game it should do what I want:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-dragger05.gif){: w="600" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-dragger06.png){: w="400" }
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-dragger07.png){: w="400" }

And the result:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-dragger08.gif){: w="600" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-cursorhide01.png){: w="600" }

Here is is working as I wanted:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/boba-cursorhide02.gif){: w="400" }
...
In hindsight, the "doable" list I had yesterday was too long 😂 I meandered a lot too so I didn't get a focused list done. Maybe my brain knew that the top item on the list wasn't just one thing. Today I locked tf in though, I wanted this done and working the way I wanted.
...
If I had recalled that one before yesterday maybe I would have seen my task "fix the slider, or have a custom hold and drag interface" and been able to break it down to see that it's **not** simple 😂

I threw these into Miro:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/miro.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-05/miro2.png){: w="400" }
