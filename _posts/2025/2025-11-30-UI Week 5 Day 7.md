...
published: true
image: /assets/img/posts/2025/2025-11-20/spill06.gif
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-30/debug01.png){: w="400" }

Simple setup of a UI Toolkit doc. Now I gotta make a script to hook up values and make em update:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-30/debug02.png){: w="400" }

And it's doing the job:

{% include embed/video.html src='/assets/img/posts/2025/2025-11-30/debug03.mp4' autoplay=true loop=true muted=true %}
...
{% include embed/video.html src='/assets/img/posts/2025/2025-11-30/spill01.mp4' autoplay=true loop=true muted=true %}

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-30/spill02.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-30/miro01.png){: w="400" }
...
{% include embed/video.html src='/assets/img/posts/2025/2025-11-30/shader01.mp4' autoplay=true loop=true muted=true %}
