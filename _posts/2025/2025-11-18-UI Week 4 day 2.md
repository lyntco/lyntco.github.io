...
published: true
image: /assets/img/posts/2025/2025-11-17/pour07.png
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-18/volume01.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-18/volume02.png){: w="400" }

The IngredientVolume also needs a maxCapacity because the container needs to overflow at some point, and a currentVolume.

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-18/volume03.png){: w="400" }

And then there needs to be some way to increase the volume and decrease the volume.

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-18/volume04.png){: w="400" }

While writing this I realised how confusing this already is so I'm gong to rename some variables:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-18/volume05.png){: w="400" }
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-18/volume06.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-18/volume07.png){: w="400" }
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-18/volume08.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-18/volume09.gif){: w="400" }
...
Geometrically it can be worked out I think. After doing some googling and getting some foggy ideas, I think you'd need the volume of the cylinder (V=πr^2h) and the volume of the liquid inside. So if I have a cylinder that's 20cm tall, and the radius is 4cm: that's roughly 3.14 * (4 * 4) * 20. In my windows calculator it says that's 1,004.8ml. Luckily that's about the same as on [this online Cylinder calculator](https://www.omnicalculator.com/math/cylinder-volume). I'll take their result since they are probably using more of pi's numbers.

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-18/volume10.jpg){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-18/volume11.png){: w="400" }
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-18/volume12.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-18/volume13.png){: w="400" }
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-18/volume14.png){: w="400" }

It's now removing the right amount from the jug as it goes into the cup. No spilling yet! 

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-18/volume15.png){: w="600" }
