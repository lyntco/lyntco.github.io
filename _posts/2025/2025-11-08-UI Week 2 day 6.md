...
published: true
image: /assets/img/posts/2025/2025-11-08/endgame01.png
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/miro01.png){: w="400" }
_Just a slice_
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/indicators01.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/indicators02.png){: w="600" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/indicators03.png){: w="400" }
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/indicators04.png){: w="400" }

And it worked, I change the BG to some bright neon so I can see the change easily:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/indicators05.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/indicators06.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/indicators07.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/indicators08.png){: w="600" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/indicators09.png){: w="400" }
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/indicators10.png){: w="400" }
_Keeping it simple for now_

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/indicators11.png){: w="400" }
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/indicators12.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/indicators13.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/seal01.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/seal02.png){: w="400" }
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/seal03.png){: w="400" }
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/seal04.png){: w="400" }
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/seal05.png){: w="400" }
_Placing the check in the update method_

With this it works:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/seal06.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/stock01.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/stock02.png){: w="400" }

And now we can't add more if we've run out:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/stock03.gif){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/sliders01.jpg){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/sliders02.png){: w="400" }
_Passing in an action so I can update the parameter on cupfill_

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/sliders03.png){: w="400" }
_Updated UpdateFillRate and MoveDragger to be reusable_

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/sliders04.png){: w="400" }
_Registering the callbacks on the new elements_

And here it is working:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/sliders05.gif){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/endgame01.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/endgame02.png){: w="400" }

And then make sure to change the state when I switch scenes:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/endgame03.png){: w="400" }

And because its a singleton I place it in both my menu scene and gameplay scene and I will keep track of the state:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/endgame04.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/endgame05.png){: w="400" }
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/endgame06.png){: w="400" }

I drew a small thumbnail of how the end screen could look:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/endgame07.jpg){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/endgame08.png){: w="400" }

### Adding stats

Looking good - now I need to add fields on CupFill to keep track of these.

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/endgame09.png){: w="400" }

### Updating stats

Then I update these where relevant in the SealCup method:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/endgame10.png){: w="400" }

### Showing stats on the end screen

And now I bind these values in the UI Builder:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/endgame11.png){: w="400" }
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/endgame12.png){: w="400" }

Then I make a new script for the EndDayUI and add code to add cupFill as a dataSource:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/endgame13.png){: w="400" }

Now I can just test it by hitting play and manually hiding and showing the end screen:

![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/endgame14.gif){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/endgame15.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/endgame16.gif){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/endgame17.gif){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/endgame18.png){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/endgame19.gif){: w="400" }
...
![Desktop View]({{ site.url }}/assets/img/posts/2025/2025-11-08/endgame20.png){: w="400" }
